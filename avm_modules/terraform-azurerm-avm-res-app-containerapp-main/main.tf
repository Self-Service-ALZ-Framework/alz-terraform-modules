...
resource "azapi_resource" "container_app" {
  ...
  lifecycle {
    ignore_changes = [
      ...
      body.properties.latestRevisionFqdn,
      body.properties.latestRevisionName,
      body.properties.customDomainVerificationId,
      body.properties.eventStreamEndpoint,
      body.properties.outboundIpAddresses,
