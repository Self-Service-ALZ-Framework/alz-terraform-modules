...
locals {
  ...
  # allowed_service_tags = [data.azurerm_network_service_tags.storage.id, "AzureContainerRegistry", "AzureMachineLearning", "BatchNodeManagement"]
  allowed_service_tags = ["Storage", "AzureContainerRegistry"]
}
